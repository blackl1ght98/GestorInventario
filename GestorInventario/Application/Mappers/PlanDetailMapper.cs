...
namespace GestorInventario.Application.Mappers
{
    public static class PlanDetailMapper
    {
        ...
        //    // Ciclo regular (siempre debería existir)
        ...
        //        Usage_type = "LICENSED", // PayPal default, o agrega campo a BD si lo necesitas
        //        CreateTime = DateTime.UtcNow, // O agrega CreatedAt a PlanDetail

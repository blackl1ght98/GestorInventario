            ...
            app.Use(async (context, next) =>
            {
                try
                {
                    ...
                    if (token != null)
                    {
                        ...
                        var encryptedAesKeyBase64 = await redis.GetStringAsync(userId + "EncryptedAesKey");
                        var privateKeyJson = await redis.GetStringAsync(userId + "PrivateKey");
                        ...
                        else
                        {
                            ...
                            var publicKeyCifradaBase64 = await redis.GetStringAsync(userId + "PublicKey");

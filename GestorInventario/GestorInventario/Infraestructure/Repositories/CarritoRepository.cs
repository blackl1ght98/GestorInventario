            ...
            try
            {
                ...
                if (int.TryParse(nombreCompleto, out usuarioId))
                {
                    ...
                    string[] direccionParts = usuarioActual.Direccion.Split(",");
                     line1 = direccionParts.Length > 0 ? direccionParts[0].Trim() : "";
                     line2 = direccionParts.Length > 1 ? direccionParts[1].Trim() : "";
                }
              ...
              await _context.AddEntityAsync(historialPedido);
                ...
                // var createdPaymentJson = await _unitOfWork.PaypalService.CreateOrderAsync(items, totalAmount, returnUrl, cancelUrl, moneda, contextAc);

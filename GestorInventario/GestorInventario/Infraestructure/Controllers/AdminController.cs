...
namespace GestorInventario.Infraestructure.Controllers
{
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> VerUsuariosPorRol(int id)
        {
            try
            {
                var roles = await ExecutePolicyAsync(() => _adminrepository.ObtenerRolesConUsuarios());
                ...
                ViewBag.Roles = todosLosRoles; // Pasar los roles a la vista
                ViewBag.RolId = id; // Para el botón "Volver a Roles"

                return View(rol.Usuarios);
            }
            catch (Exception ex)
            {

...
namespace GestorInventario.Infraestructure.Controllers
{
    public class AdminController : Controller
    {
        ...
        //Metodo que obtiene los datos de los usuarios
        ...
        //Metodo encargado de obtener y editar el usuario
        [Authorize(Roles = "Administrador")]
        ...
        //Metodo para obtener los datos del usuario actual y editarlo
        [Authorize]
        ...
        //Metodo para obtener y eliminar un usuario
        [Authorize(Roles = "Administrador")]
        ...
        public async Task<IActionResult> VerUsuariosPorRol(int id, [FromQuery] Paginacion paginacion)
        {
            ...
            {
                /*
                 Obtener el rol con sus usuarios asociados ademas antes de implementar la paginacion 
                estaba esta consulta separada en 2  consultas lo que se ha hecho es fusionarlo en una sola consulta
        ...
        public async Task<IActionResult> CreateRol(RolViewModel model )
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    var (success, errorMessage) = await ExecutePolicyAsync(() => _adminrepository.CrearRol(model));
                    if (success)
                    {
                    ...
                    {
                        TempData["ErrorMessage"] = errorMessage;
                        return RedirectToAction(nameof(CreateRol));
                    }
        ...
        public async Task<IActionResult> CambiarRol([FromBody] CambiarRolRequestDTO request)
        {
            try
            {
                ...
                // Validar que el rol del usuario esté cargado

...
//    secret = builder.Configuration["ClaveJWT"];
//    // Usa valores de variables de entorno en producción

//}
//PEDIR AYUDA PARA CORREGIR LA CONFIGURACION DE DOCKER
var isDocker = Environment.GetEnvironmentVariable("IS_DOCKER") == "true";
var dbHost = isDocker ? Environment.GetEnvironmentVariable("DB_HOST") : "DESKTOP-2TL9C3O\\SQLEXPRESS";
var dbName = Environment.GetEnvironmentVariable("DB_NAME");
var dbPassword = Environment.GetEnvironmentVariable("DB_SA_PASSWORD");
string connectionString = $"Data Source={dbHost};Initial Catalog={dbName};User ID=pepe;Password={dbPassword};TrustServerCertificate=True";

...
namespace GestorInventario.Application.Services.Carrito
{
    public class ShopCartService : IShopCartService
    {
        ...
        public ShopCartService(ICarritoRepository carritoRepository, IOrderService pedido, IProductoRepository producto,
        ICurrentUserAccessor currentUserAccessor,ILogger<ShopCartService> logger, IPedidoRepository pedidoRepository)
        {

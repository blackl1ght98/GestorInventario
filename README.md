...
<body>
    ...
    - <p><strong>NOMBRESERVIDORBASEDEDATOS</strong>: Se obtiene al abrir el programa SQL Server.</p>
    -<p> <strong>NOMBREBASEDATOS</strong>: En el programa de SQL Server vemos qué nombre tiene nuestra base de datos.</p>
    -<p> <strong>NOMBREPROYECTO</strong>: El nombre que tenga nuestro proyecto en SQL Server.</p></p>
